...
class EvaluateListAdapter(private val context: Context, private val itemClickListener: (Evaluate) -> Unit) : ListAdapter<Evaluate, EvaluateListViewHolder>(Evaluate.diffUtil) {
