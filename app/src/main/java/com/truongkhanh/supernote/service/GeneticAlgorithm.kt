...
//    }
    ...
    private fun fillSpaceTimeWithTodo(
        ...
        val result = spaceTimes.clone() as HashMap<Long, Todo?>
        listDraftNote.forEach { draftNote ->
            // Lấy toàn bộ thời gian rãnh còn lại
            val freeSpaceTimes = getFreeSpaceTimes(result)
...
//        }
    ...
    private fun createSpaceTimes(
        ...
        this.totalDay = endCalendar.get(Calendar.DAY_OF_YEAR) - startCalendar.get(Calendar.DAY_OF_YEAR)
