...
class HomeViewModel(private val context: Context) : ViewModel() {
    ...
    val notifyDataRemoved: LiveData<Event<Boolean>> get() = _notifyDataRemoved
    private var _notifyDataRemoved = MutableLiveData<Event<Boolean>>()
    ...
    fun removeTodo(todo: Todo) {
        todoRepository.delete(todo)
            ...
            .subscribeOn(Schedulers.io())
            .subscribe {
                _notifyDataRemoved.value = Event(true)
            }.disposedBy(bag)
    }
